    ...
    <div class="container bg-white  q-mt-xl">
            <div class="row ">
                ...
                <div v-if="$q.screen.gt.sm" class="col-xs-12 col-sm-6">
                    <q-img v-if="!state.sentOtp" height="480" width="580" src="images/reg1.png"/>
                    <q-img v-if="state.step==='otp' && state.sentOtp" height="480" width="580" src="images/reg2.png"/>
                    <q-img v-if="state.step === 'register'" height="480" width="580" src="images/reg3.png"/>
                </div>
            </div>
